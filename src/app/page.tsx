          ...
          <section className="section-center-layout flex flex-col">
              <form>
                  <div className="w-full grid items-center gap-1.5 mb-4">
                      ...
                      <Input className="input-primary px-3 py-6" type="email" id="email" placeholder="이메일을 입력해주세요." />
                  </div>
                  ...
                  <div className="w-full grid items-center gap-1.5 mb-6">
                      ...
                      <Input className="input-primary px-3 py-6" type="password" id="password" placeholder="이메일을 입력해주세요." />
                  </div>
