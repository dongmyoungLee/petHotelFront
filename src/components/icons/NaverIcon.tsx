...
export default function NaverIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg width="100%" height="100%" {...props} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g>
